...
public class TestNgwithMlcalc_excel {
...
WebDriver driver = null;
    ...
    public void preconditions() throws IOException, InterruptedException, BiffException {
        ...
        driver = Reusable_Method.defineTheDriver();
    ...
    public void testScenario() throws WriteException, InterruptedException {
        ...
        for(int i =1; i <rowCount; i++){
            ...
            Reusable_Method.sendKeysMethod(driver,"//input[@id='ma']",pPrice,"Purchase Price");
            //enter the down payment
            Reusable_Method.sendKeysMethod(driver,"//input[@id='dp']",dPayment,"Down Payment");
            //enter mortgage term
            Reusable_Method.sendKeysMethod(driver,"//input[@id='mt']",mTerm,"Mortgage Term");
            //enter interest rate
            Reusable_Method.sendKeysMethod(driver,"//input[@id='ir']",iRate,"Interest Rate");
            //select start month
            Reusable_Method.dropdownByText(driver,"//select[@name='sm']",stMonth,"Start Month");
            //select start year
            Reusable_Method.dropdownByText(driver,"//select[@name='sy']",stYear,"Start Year");
            //click on Calculate
            Reusable_Method.clickOnElement(driver,"//input[@value='Calculate']","Calculate");
