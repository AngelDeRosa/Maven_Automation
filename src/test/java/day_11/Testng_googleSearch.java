...
//you have to initialize global variables with some null/empty values
    ...
    public void googleSearch() throws InterruptedException {
        ...
        Thread.sleep(3000);
        //enter a keyword
        Reusable_Method.sendKeysMethod(driver,"//*[@name='q']","cars","Google Search Field");
        //submit on google search button
        Reusable_Method.submitOnElement(driver,"//*[@name='btnK']","Google Search Button");
        Thread.sleep(2500);
    ...
    public void captureSearchNumber(){
        String result = Reusable_Method.captureText(driver,"//*[@id='result-stats']",0,"Google Search Results");
