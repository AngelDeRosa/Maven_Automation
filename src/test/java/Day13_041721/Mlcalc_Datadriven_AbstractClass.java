...
//this is where the for loop will start to iterate through your excel data
        for(int i =1; i <rowCount; i++){
            ...
            Reusable_action.sendKeysMethod(driver,"//input[@id='ma']",pPrice,logger,"Purchase Price");
            //enter the down payment
            Reusable_action.sendKeysMethod(driver,"//input[@id='dp']",dPayment,logger,"Down Payment");
            //enter mortgage term
            Reusable_action.sendKeysMethod(driver,"//input[@id='mt']",mTerm,logger,"Mortgage Term");
            //enter interest rate
            Reusable_action.sendKeysMethod(driver,"//input[@id='ir']",iRate,logger,"Interest Rate");
            //click on Show advanced options
            Reusable_action.clickOnElement(driver,"//*[text()='Show advanced options']",logger,"Show advanced options");
            //select start month
            Reusable_action.dropdownByText(driver,"//select[@name='sm']",stMonth,logger,"Start Month");
            //select start year
            Reusable_action.dropdownByText(driver,"//select[@name='sy']",stYear,logger,"Start Year");
            //click on Calculate
            Reusable_action.clickOnElement(driver,"//input[@value='Calculate']",logger,"Calculate");

            //capture monthly payment
            String monthlyPayment = Reusable_Method.captureText(driver,"//td[@align='center']",0,"Monthly Payment");
